...
namespace Jonnitto\PrettyEmbedHelper\FusionObjects;
...
class ReplaceIframesImplementation extends AbstractFusionObject
{
    ...
    public function evaluate(): string
    {
        ...
        if (
            !strpos($content, '<iframe') &&
            (!strpos($content, 'https://www.youtube.com/embed') ||
                !strpos($content, 'https://www.youtube-nocookie.com/embed') ||
                !strpos($content, 'https://player.vimeo.com/video'))
        ) {
            return $content;
        }
